...
- Theme chủ đạo của website **được định nghĩa tại** `src/styles/index.css` và `src/styles/fonts.css`
...
- Spacing đã có sẵn trong `src/styles/index.css`
...
- Chỉ sử dụng **màu đơn sắc (flat color)** theo palette trong `index.css`
